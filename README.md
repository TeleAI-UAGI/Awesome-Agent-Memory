...
83. **[BlaBla](https://github.com/Kiborgik/blabla)**
      ![Star](https://img.shields.io/github/stars/Kiborgik/blabla.svg?style=social&label=Star)
      [[code](https://github.com/Kiborgik/blabla)]
      _Project memory for coding agents: executable behavior and structure contracts, queried between sessions and checked by a coverage-guided verifier and a completion gate._
